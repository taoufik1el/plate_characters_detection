...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    box_wh = K.exp(feats[..., 2:4]) * anchors_tensor / K.cast(input_shape, K.dtype(feats))
...
def define_loss(anchors, num_classes, ignore_thresh=.5):
    def yolo_loss(yolo_outputs, y_true):
        ...
        for l in range(num_layers):
            ...
            raw_true_wh = K.log(y_true[l][..., 2:4] / anchors[anchor_mask[l]] * input_shape)
